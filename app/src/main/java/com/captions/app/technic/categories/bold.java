...
public class bold extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Bold");
        ...
        databaseReference = FirebaseDatabase.getInstance().getReference("bold");
        myShayari = new Model();
