...
public class bestfriend extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Best Friend");
        ...
        databaseReference = FirebaseDatabase.getInstance().getReference("bestfriend");
        myShayari = new Model();
